...
<form action="profile_action.php" method="POST">   
    ...
    <h4 class="card-title mb-4 mt-1">
        ...
        <div class="form-group">
            <label for="total_support" class="label">Target Total Support: JPY</label>
            <input name="total_support" type="text" class="form-control" placeholder="Currency: JPY" required>
        </div>
        <div class="form-group">
    ...
    <article class="card-body">
        <div class="form-group">
            ...
            <input name="return_support" type="text" class="form-control" placeholder="Currency: JPY" required>
        </div>
        <div class="form-group">
